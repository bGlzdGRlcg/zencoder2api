...
每个 PR/push 必须通过 `.github/workflows/ci.yml` 的 fmt、vet、staticcheck、
govulncheck、secret scan 和容器构建。release workflow 会重新验证 tag、生成
校验和及 SPDX SBOM，并为归档和镜像生成 provenance/attestation。
